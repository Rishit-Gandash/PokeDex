...
var PokeAPI = /** @class */ (function () {
    ...
    PokeAPI.prototype.fetchLocations = function (pageURL) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, fetch(PokeAPI.baseURL)];
                    case 1:
                        response = _a.sent();
                        if (!response.ok) {
    ...
    PokeAPI.prototype.fetchLocation = function (locationName) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, 0];
            });
